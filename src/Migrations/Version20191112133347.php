 ...
 */
final class Version20191112133347 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(50) NOT NULL COLLATE BINARY, password VARCHAR(50) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, reset_hash VARCHAR(100) NOT NULL COLLATE BINARY)');
