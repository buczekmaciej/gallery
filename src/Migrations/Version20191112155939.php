 ...
 */
final class Version20191112155939 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gallery AS SELECT id, category_id, image, likes, views, saves, title FROM gallery');
        ...
        $this->addSql('INSERT INTO gallery (id, category_id, image, likes, views, saves, title) SELECT id, category_id, image, likes, views, saves, title FROM __temp__gallery');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gallery AS SELECT id, category_id, image, likes, views, saves, title FROM gallery');
        $this->addSql('DROP TABLE gallery');
        $this->addSql('CREATE TABLE gallery (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, image BLOB NOT NULL, likes INTEGER NOT NULL, views INTEGER NOT NULL, saves INTEGER NOT NULL, title VARCHAR(300) DEFAULT NULL)');
        $this->addSql('INSERT INTO gallery (id, category_id, image, likes, views, saves, title) SELECT id, category_id, image, likes, views, saves, title FROM __temp__gallery');
        $this->addSql('DROP TABLE __temp__gallery');
        $this->addSql('CREATE INDEX IDX_472B783A12469DE2 ON gallery (category_id)');
        $this->addSql('DROP INDEX IDX_1F266630A76ED395');
