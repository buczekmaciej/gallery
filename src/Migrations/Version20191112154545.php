 ...
 */
final class Version20191112154545 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE gallery (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, category_id INTEGER NOT NULL, image BLOB NOT NULL, likes INTEGER NOT NULL, views INTEGER NOT NULL, saves INTEGER NOT NULL, title VARCHAR(300) DEFAULT NULL, CONSTRAINT FK_472B783A12469DE2 FOREIGN KEY (category_id) REFERENCES categories (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, login VARCHAR(50) NOT NULL COLLATE BINARY, password VARCHAR(50) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, reset_hash VARCHAR(100) NOT NULL COLLATE BINARY, color_schema VARCHAR(5) DEFAULT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__gallery');
        $this->addSql('CREATE INDEX IDX_472B783A12469DE2 ON gallery (category_id)');
        $this->addSql('ALTER TABLE user ADD COLUMN color_scheme VARCHAR(5) DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_1F266630A76ED395');
        $this->addSql('DROP INDEX IDX_1F2666304E7AF8F');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_gallery AS SELECT user_id, gallery_id FROM user_gallery');
        $this->addSql('DROP TABLE user_gallery');
