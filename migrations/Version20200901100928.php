 ...
 */
final class Version20200901100928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gallery AS SELECT id, category_id, uploader_id, added_at, image FROM gallery');
        ...
        $this->addSql('INSERT INTO gallery (id, category_id, uploader_id, added_at, image) SELECT id, category_id, uploader_id, added_at, image FROM __temp__gallery');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE gallery');
        $this->addSql('CREATE TABLE gallery (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, uploader_id INTEGER NOT NULL, image VARCHAR(255) NOT NULL, added_at DATETIME DEFAULT NULL, category_id INTEGER NOT NULL)');
