 ...
 */
final class Version20200906111455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_F11FA745126F525E');
        $this->addSql('DROP INDEX IDX_F11FA74559BB1592');
        $this->addSql('DROP INDEX IDX_F11FA745A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__reports AS SELECT id, user_id, reason_id, item_id, note, status FROM reports');
        $this->addSql('DROP TABLE reports');
        $this->addSql('CREATE TABLE reports (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reason_id INTEGER NOT NULL, item_id INTEGER NOT NULL, note CLOB NOT NULL COLLATE BINARY, status VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_F11FA745A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F11FA74559BB1592 FOREIGN KEY (reason_id) REFERENCES reasons (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F11FA745126F525E FOREIGN KEY (item_id) REFERENCES gallery (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO reports (id, user_id, reason_id, item_id, note, status) SELECT id, user_id, reason_id, item_id, note, status FROM __temp__reports');
        $this->addSql('DROP TABLE __temp__reports');
        $this->addSql('CREATE INDEX IDX_F11FA745126F525E ON reports (item_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__reports AS SELECT id, user_id, reason_id, item_id, note, status FROM reports');
        $this->addSql('DROP TABLE reports');
        $this->addSql('CREATE TABLE reports (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, reason_id INTEGER NOT NULL, item_id INTEGER NOT NULL, note CLOB NOT NULL, status VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO reports (id, user_id, reason_id, item_id, note, status) SELECT id, user_id, reason_id, item_id, note, status FROM __temp__reports');
        $this->addSql('DROP TABLE __temp__reports');
        $this->addSql('CREATE INDEX IDX_F11FA745A76ED395 ON reports (user_id)');
        $this->addSql('CREATE INDEX IDX_F11FA74559BB1592 ON reports (reason_id)');
