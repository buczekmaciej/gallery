 ...
 */
final class Version20200902083920 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reasons (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, reason VARCHAR(355) NOT NULL)');
